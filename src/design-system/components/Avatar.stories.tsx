...
/**
 * Aucun pseudo réel : les noms de cette story sont inventés, comme le veut la règle du
 * Storybook public.
 */
const meta = {
...
/** Sans image : les initiales, plutôt que le rond gris qui laisse croire à un chargement. */
